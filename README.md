...
1. **Main Launch File** (default configuration):
   ```bash
   ros2 launch lab3 lab3_bringup.launch.py
   ```

2. **Launch with custom namespaces and frequency**:
   ```bash
   ros2 launch lab3 lab3_bringup.launch.py XXXX:=custom_eater YYYY:=custom_killer sampling_frequency:=50.0
   ```

### Configuration

**Namespace Configuration:**
- Default eater namespace: `eater_turtle`
- Default killer namespace: `killer_turtle`
- Default sampling frequency: `100.0` Hz

**Launch Parameters:**
- `XXXX`: Eater turtle namespace (default: `eater_turtle`)
- `YYYY`: Killer turtle namespace (default: `killer_turtle`)  
- `sampling_frequency`: Control frequency in Hz (default: `100.0`)
